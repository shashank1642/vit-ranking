...
function Faq() {
    return (
        ...
        <section className="grid grid-cols-1">
            <div className="col-span-1 max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl">
        <div className="md:flex">
          ...
          <div className="p-8">
            ...
            <p className="block mt-1 text-lg leading-tight font-medium text-black hover:underline">Finding customers for your new business</p>
